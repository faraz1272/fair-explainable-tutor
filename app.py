...
backend = st.sidebar.selectbox("Backend", ["huggingface", "openai"], index=0)
model_hf = st.sidebar.selectbox(
    "HF model", ["microsoft/Phi-3-mini-4k-instruct", "TinyLlama/TinyLlama-1.1B-Chat-v1.0"], index=0
)
model_oa = st.sidebar.selectbox("OpenAI model", ["gpt-4o-mini"], index=0)
