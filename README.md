...
> Replace with your actual files or keep placeholders:
>
> - `system_architecture.png` *(already in repo)*
> - `docs/pipeline_overview.png`
> - `docs/rdf_corpus_structure.png`
> - `docs/provenance_flow.png`
> - `UI_v1.jpeg`, `UI_v2.jpeg` *(screens: inputs/contexts; lesson/questions/fairness/provenance)*

**Example embedding:**
```markdown
![System Architecture](system_architecture.png)

![UI — Inputs & Contexts](UI_v1.jpeg)
![UI — Lesson, Questions, Fairness, Provenance](UI_v2.jpeg)
```
